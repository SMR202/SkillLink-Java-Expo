...
public class BookingService {
    ...
    public BookingResponse actionBooking(Long providerId, Long bookingId, BookingActionRequest request) {
        ...
        if (booking.getStatus() != BookingStatus.PENDING) {
            throw new BadRequestException("This booking has already been " + booking.getStatus().name().toLowerCase() + ".");
        }
        ...
        if ("accept".equals(action)) {
            ...
            Notification notification = Notification.builder()
                ...
                .message(booking.getProvider().getUser().getFullName() + " accepted your booking for " + booking.getPreferredDate())
            ...
            Notification notification = Notification.builder()
                ...
                .message(booking.getProvider().getUser().getFullName() + " declined your booking. Reason: " + request.getDeclineReason())
